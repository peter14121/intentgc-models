...
class Node2VecFeatureI2IGCNModel(object):
  ...
  def make_features_and_embedding(self):
    ...
    cur_item_final_embedding = self.one_layer_item_gcn(cur_item_ids, cur_item_whole_embedding)
    cur_walk1_item_final_embedding = self.one_layer_item_gcn(cur_walk1_item_ids, cur_walk1_item_whole_embedding)
    cur_walk2_item_final_embedding = self.one_layer_item_gcn(cur_walk2_item_ids, cur_walk2_item_whole_embedding)
    ...
    # 4. return
    return [cur_item_final_embedding, cur_walk1_item_final_embedding, cur_walk2_item_final_embedding, cur_neg_item_final_embedding]
