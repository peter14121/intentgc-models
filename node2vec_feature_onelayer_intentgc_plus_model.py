...
class Node2VecFeatureOneLayerIntentGCPlusModel(object):
  ...
  def create_convolve_weights(self):
    ...
    if self.ps_num > 1:
      ...
      self.convolve_weights_user_shop_neighbor = tf.get_variable("convolve_weights_user_shop_neighbor", (1,), initializer=self.get_initializer(stddev=self.config.convolve_stddev), partitioner=tf.min_max_variable_partitioner(max_partitions=self.ps_num))
      ...
      self.convolve_weights_user_shop_neighbor = tf.get_variable("convolve_weights_user_shop_neighbor", (1,), initializer=self.get_initializer(stddev=self.config.convolve_stddev))
