...
class Node2VecFeatureTwoLayerIntentGCModel(object):
  ...
  def two_layer_user_gcn(self, cur_user_1s_final_embedding):
    ...
    # [batch, neighbor_cnt, emb_size]
    cur_user_neighbor_final_embedding = (cur_user_2s_neighbor_pool_embedding * self.convolve_weights_user_neighbor) + (cur_user_1s_neighbor_format_embedding * self.convolve_weights_user_self)
    
    # [batch, emb_size]
    cur_user_neighbor_pool_embedding = tf.reduce_mean(cur_user_neighbor_final_embedding, axis = 1)
   
    # [batch,  emb_size]
    cur_user_final_embedding = (cur_user_neighbor_pool_embedding * self.convolve_weights_user_2s_neighbor) + (cur_user_1s_final_embedding * self.convolve_weights_user_2s_self)
