...
class Node2VecFeatureMetapathModel(object):
  ...
  def build_train_graph(self):
    ...
    cur_item_whole_embedding, cur_user_whole_embedding, cur_neg_item_whole_embedding, cur_item_1s_neighbor_pool_embedding = self.make_features_and_embedding()

    # 2. build network
    self.build_network(cur_item_whole_embedding, cur_user_whole_embedding, cur_neg_item_whole_embedding, cur_item_1s_neighbor_pool_embedding)
  ...
  def cal_loss(self):
    ...
    self.loss = tf.reduce_sum(pre_loss, 0) + tf.reduce_sum(meta_pre_loss, 0)
    
    return True
 

  def build_network(self, cur_item_whole_embedding, cur_user_whole_embedding, cur_neg_item_whole_embedding, cur_item_1s_neighbor_pool_embedding):
    self.build_network_for_item(cur_item_whole_embedding)
  ...
  def make_features_and_embedding(self):
    ...
    # 4. return
    return [cur_item_whole_embedding, cur_user_whole_embedding, cur_neg_item_whole_embedding, cur_item_1s_neighbor_pool_embedding]
